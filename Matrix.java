...
class Matrix {
	 ...
	 */
//	public static native void multiplyMM(float[] result, int resultOffset, float[] lhs,
//			int lhsOffset, float[] rhs, int rhsOffset);
	public static void multiplyMM(float[] result, int resultOffset, float[] lhs, int lhsOffset,
			float[] rhs, int rhsOffset) {
		for (int i = 0; i < 4; i++) {
			for (int j = 0; j < 4; j++) {
				float sum = 0;
				for (int k = 0; k < 4; k++) {
					sum = sum + lhs[i * 4 + k + lhsOffset] * rhs[k * 4 + j + rhsOffset];
				}
	 ...
	 */
	public static native void multiplyMV(float[] resultVec, int resultVecOffset, float[] lhsMat,
	 ...
	 * @param far
	 */
	public static void orthoM(float[] m, int mOffset, float left, float right, float bottom,
	 ...
	 * @param far
	 */
	public static void frustumM(float[] m, int offset, float left, float right, float bottom,
			float top, float near, float far) {
		if (left == right) {
			throw new IllegalArgumentException("left == right");
		}
	 ...
	 * @param zFar
	 */
	public static void perspectiveM(float[] m, int offset, float fovy, float aspect, float zNear,
			float zFar) {
	 ...
	 */
	public static void scaleM(float[] sm, int smOffset, float[] m, int mOffset, float x, float y,
			float z) {
		for (int i = 0; i < 4; i++) {
			int smi = smOffset + i;
			int mi = mOffset + i;
	 ...
	 */
	public static void translateM(float[] tm, int tmOffset, float[] m, int mOffset, float x,
			float y, float z) {
		for (int i = 0; i < 12; i++) {
	 ...
	 */
	public static void rotateM(float[] rm, int rmOffset, float[] m, int mOffset, float a, float x,
			float y, float z) {
		synchronized (sTemp) {
	 ...
	 */
	public static void setLookAtM(float[] rm, int rmOffset, float eyeX, float eyeY, float eyeZ,
